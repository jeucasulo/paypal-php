                        ...
                        <div class="card-group">
                            <div class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                  ...
                                  <li class="list-group-item"><b>Trigger:</b> PayPal Checkout Button <img src="REF-REST/pp-ec-button.png"></img> </li>
                ...
                <span id="executePaymentNotification" class="badge badge-success float-right"></span>
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="card-group">
                                ...
                                <ul class="list-group list-group-flush">
                                  <li class="list-group-item"><b>Trigger:</b> PayPal Checkout Button <img src="REF-REST/pp-execute-btn - bt.png"></img> </li>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-body">
        <img src="REF-REST/pp-auth-form.png"></img>
      </div>
  </div>
</div>
<!--modals-->
...
<div class="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-body">
        <img src="REF-REST/pp-billingAgreementContinue.png"></img>
      </div>
  </div>
</div>
<!--modals-->
...
<script src="REF-REST/jquery-3.3.1.min.js"></script>
...
<script src="REF-REST/ec-button.js"></script>
...
<script type="text/javascript" src="REF-REST/check-token.js"></script>
<script type="text/javascript" src="REF-REST/inactive-token.js"></script>
<script type="text/javascript" src="REF-REST/create-payment.js"></script>
