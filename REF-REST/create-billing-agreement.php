...
file_put_contents('_token_id1.txt', $_POST);

$paypalCheckout = new BillingAgreement();
$accessToken = $paypalCheckout->getToken();
$paypalCheckout->createAgreement($accessToken,$token_id);
...
class BillingAgreement{
  ...
  public function createAgreement($accessToken, $token_id){
...
//   file_put_contents("responseRunObjGetIdOnly.txt", $runObj['id']);
  ...
  file_put_contents("_responseAgreementCreate.json", $run);
