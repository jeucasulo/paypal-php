<div class="container">
    <div class="row">
        <div class="col">
            <center>
                <button class="btn btn-default" id="createInvoicingBtn">Create invoicing</button>
            </center>
        </div>
        <div class="col">
            <center>
                <button class="btn btn-default" id="sendInvoicingBtn">Send invoicing</button>
            </center>
        </div>
    </div>
</div>
...
<!--<script src="/Invoicing/invoicing.js" type="text/javascript"> </script>-->
<script> 
$(document).ready(function(){
        
        $("#createInvoicingBtn").click(PayPal.CreateInvoicing);
        $("#sendInvoicingBtn").click(PayPal.SendInvoicing);
});


var PayPal = {
    
    CreateInvoicing:function(){
        $.ajax({
        // url: "execute-payment.php",// localhost
        url: "Invoicing/invoicing-script.php",// cloud9
        type: "POST",
        data: {"create":"create"},
        ...
        console.log("App.Invoicing.Done");
        }).fail(function(jqxhr, textStatus, errorThrown) {
            console.log(jqxhr);
            console.log(textStatus);
            console.log(errorThrown);
            console.log("App.Invoicing.Fail");
        });
    
    },
    SendInvoicing:function(){
    // alert('send');
    $.ajax({
    // url: "execute-payment.php",// localhost
    url: "Invoicing/invoicing-script.php",// cloud9
    ...
    console.log("App.SendInvoicing.Done");
    }).fail(function(jqxhr, textStatus, errorThrown) {
        console.log(jqxhr);
        console.log(textStatus);
        console.log(errorThrown);
        console.log("App.SendInvoicing.Fail");
    });
