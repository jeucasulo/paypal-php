...
isset($_POST['id']) ? $paypalCheckout->getDetails($_POST['id']) : $paypalCheckout->executeRefund($_POST['refund']);
...
//   file_put_contents("responseRunObjGetIdOnly.txt", $runObj['id']);
   ...
   file_put_contents("_responseGetDetails.txt", $run);
 ...
 public function executeRefund($id){
  ...
  $payId = $id;
   ...
   $url = "https://api.sandbox.paypal.com/v1/payments/sale/".$payId."/refund";
   ...
   //   file_put_contents("createPaymentResponse.txt", $run);
    ...
    //   file_put_contents("responseRunObjJsonConvert.txt", json_encode($runObj));
    //   file_put_contents("responseRunObjJsonConvertGetIdOnly.txt", json_encode($runObj['id']));
      file_put_contents("_responseExecuteRefund.txt", $run);
