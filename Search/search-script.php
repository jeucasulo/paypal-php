...
isset($_POST['refund']) ? $paypalCheckout->executeRefund($accessToken) : $paypalCheckout->getDetails($_POST['payId']);
...
//   $url = "https://api.sandbox.paypal.com/v1/payments/payment/PAY-4TN94532BT647290YLQTLZ2Q";
   $url = "https://api.sandbox.paypal.com/v1/payments/sale/67D22837NN7279935/refund";
//   $url = "https://api.sandbox.paypal.com/v1/payments/payment/PAY-0US81985GW1191216KOY7OXA ";
