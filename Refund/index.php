<div class="container">
    <div class="row d-flex justify-content-center">
        ...
        <div class="col">
            <button id="getTransectionBtn" class="btn btn-default">Get transaction</button>
        </div>
        <div class="col">
            <button id="executeRefundBtn" name="executeTransectionBtn" class="btn btn-default">Execute Refund</button>
        </div>
    </div>
    <br>
    <div class="row d-flex justify-content-center">
...
var Transection = {
    ...
    $.ajax({
        ...
        url: "Refund/transactions-script.php",// cloud9
        type: "POST",
        data: {'id': id},
