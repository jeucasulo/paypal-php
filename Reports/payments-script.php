...
isset($_POST['nextIndex']) ? $paypalCheckout->getList($accessToken) : $paypalCheckout->getDetails($_POST['id']);
...
class PaypalCheckout{
  ...
  public function getList($accessToken){
   ...
   $url = "https://api.sandbox.paypal.com/v1/payments/payment?count=20&start_index=".$nextIndex."&sort_by=create_time&sort_order=desc";
...
//   $url = "https://api.sandbox.paypal.com/v1/payments/payment/PAY-4TN94532BT647290YLQTLZ2Q";
   $url = "https://api.sandbox.paypal.com/v1/payments/payment/".$payId."";
