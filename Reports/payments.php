...
function LoadTable(nextIndex){
    ...
    //   $("#nextIndex").text(nextIndex+20);
       ...
       $.ajax({
        ...
        url: "Reports/payments-script.php",// cloud9
        type: "POST",
        ...
        arr = jQuery.map( data.payments, function( n, i ) {
          list += "<tr><td><a href='/?r=payment&id="+n.id+"' target='_blank'>"+ n.id + "<a></td><td>" + n.state +"</td><td>"+n.transactions[0].amount.total+"</td><td>"+n.transactions[0].related_resources[0].sale.state+"</td><td>"+n.create_time+"</td></tr>";
