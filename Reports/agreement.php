<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="row">
            ...
            <button type="text" name="getAgreementBtn" id="getAgreementBtn" class="btn btn-default">Get Agreement Transections</button>
            <span id="transId"> <?php echo $_GET['transId']?> </span> 
        </div>
    </div>
</div>
...
$(document).ready(function(){
    let transId = $("#transId").html();
    console.log("transId"+transId)
    $("#loader").hide();
    // Agreement.LoadTable(transId);
    $("#getAgreementBtn").click(Agreement.LoadTable(transId));
