<div class="container">
    <div class="row">
        <div class="col">
            <center>
                <!--<button class="btn btn-default" id="createInvoicingBtn">Checkout</button>-->
                <a href="PPEC-NVP/setExpressCheckout.php" class="btn btn-success" id="createInvoicingBtn">Checkout</a>
            </center>
        </div>
    </div>
</div>
...
aqui
<iframe src="https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-0E863128272397315" width="500" height="400" ></iframe>


<?php

$file_path = "https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-0E863128272397315";
