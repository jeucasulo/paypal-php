<?php
    // $disabled = file_exists('Subscriptions/responsePlanCreate.json')? "disabled" : "";
    $created = file_exists('Subscriptions/responsePlanCreate.json')? true : false;
?>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <h1 class="text-center">
                <button class="btn btn-default" id='createPlanBtn' disabled>Create Plan</button><br>
            </h1>

            <h6>                
                <?php
                    if($created){
                      $path = file_get_contents('Subscriptions/responsePlanCreate.json') ;
        ...
        <div class="col">
            <!-- paypalbutton -->
            <h1 class="text-center">
                <button class="btn btn-default" id='activatePlanBtn' disabled>Activate Plan</button><br>
            </h1>
        ...
        <div class="col">
            <!-- paypalbutton -->
            <h1 class="text-center">
                <button class="btn btn-default" id='createAgreementBtn' disabled>Create Agreement</button><br>
            </h1>
        </div>
...
<script>
    $(document).ready(function(){
        ...
        function checkPlan(){
            $.ajax({
                url:'Subscriptions/responsePlanCreate.json',
                type:'HEAD',
                error: function(data)
                {
                    console.log("Não existe");
                    $("#createPlanBtn").attr("disabled", false);
                },
        ...
        function getPlan(){
            $.ajax({
                ...
                url: "Subscriptions/get-plan.php",// cloud9
                type: "POST",
                ...
                if(data.state=="CREATED"){
                    $("#activatePlanBtn").prop("disabled", false);
                }else if(data.state=="ACTIVE"){
                    $("#createAgreementBtn").attr("disabled", false);
                }
                
            }).fail(function(jqxhr, textStatus, errorThrown) {
                console.log("App.GetPlan.Fail");
                console.log(jqxhr);
                console.log(textStatus);
        ...
        $("#createPlanBtn").click(function(){
                $.ajax({
                    // url: "execute-payment.php",// localhost
                    url: "Subscriptions/create-plan.php",// cloud9
                    type: "POST",
                    dataType: "json", //error dataType since the callback response isnt a json
                }).done(function(data, textStatus, jqxhr) {
                    // approval[0] = data.links[1].href;
                    // sessionStorage.setItem('approval_url', data.links[1].href);
                    console.log("App.CreatePlan.Done");
                    console.log("Data");
                    console.log(data);
                    // console.log(typeof(data));
                    // console.log(data);
                    ...
                    $("#createPlanBtn").attr("disabled", true);
                    $("#activatePlanBtn").prop("disabled", false);
                    ...
                    console.log(textStatus);
                    console.log(errorThrown);
                    console.log("App.CreatePlan.Fail");
                });
        ...
        $("#activatePlanBtn").click(function(){
                $.ajax({
                    // url: "execute-payment.php",// localhost
                    url: "Subscriptions/activate-plan.php",// cloud9
                    type: "POST",
                    // dataType: "json", //error dataType since the callback response isnt a json
                }).done(function(data, textStatus, jqxhr) {
                    // approval[0] = data.links[1].href;
                    ...
                    // console.log(textStatus);
                    // console.log(jqxhr);
                    console.log("App.ActivatePlan.Done");
                    ...
                    console.log(textStatus);
                    console.log(errorThrown);
                    console.log("App.ActivatePlan.Fail");
                });

        });
        
        $("#createAgreementBtn").click(function(){
                $.ajax({
                    // url: "execute-payment.php",// localhost
                    url: "Subscriptions/create-agreement.php",// cloud9
                    type: "POST",
                    dataType: "json", //error dataType since the callback response isnt a json
                }).done(function(data, textStatus, jqxhr) {
                    // approval[0] = data.links[1].href;
                    ...
                    // console.log(textStatus);
                    // console.log(jqxhr);
                    console.log("App.CreateAgreement.Done");
                    console.log("Data");
                    console.log(data);
                    ...
                    console.log(textStatus);
                    console.log(errorThrown);
                    console.log("App.CreateAgreement.Fail");
                });
